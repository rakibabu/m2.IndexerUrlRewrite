...
abstract class AbstractIndexer implements IndexerActionInterface, MviewActionInterface
{
    ...
    public function executeFull()
    {
        foreach ($this->_storeManager->getStores() as $store) {
            ...
            $this->executeStore($store->getId(), $store->getRootCategoryId());
        }
    }
     ...
     * @return void
     */
    private function executeStore($storeId, $rootCategoryId)
    {
        foreach ($this->getEntityCollection($storeId, $rootCategoryId) as $entity) {
